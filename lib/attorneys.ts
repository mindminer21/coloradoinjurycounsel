...
const BASE: Omit<Attorney, "photo">[] = [
  {
    ...
    bio: [
      "Jeff Schell is a Denver-based partner at Whiteford and the Managing Director of Whiteford Mountain West. A Colorado attorney and a member of the Colorado Trial Lawyers Association, he was named one of ColoradoBiz Magazine's 25 Most Influential Young Professionals in Colorado.",
